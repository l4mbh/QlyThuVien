...
router.post("/:id/inventory-adjustments", auth_middleware_1.authMiddleware, (0, auth_middleware_1.roleMiddleware)([client_1.UserRole.ADMIN, client_1.UserRole.STAFF]), bookController.adjustInventory);
router.get("/:id/inventory-logs", auth_middleware_1.authMiddleware, (0, auth_middleware_1.roleMiddleware)([client_1.UserRole.ADMIN, client_1.UserRole.STAFF]), bookController.getInventoryLogs);
