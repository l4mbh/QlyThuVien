...
class CategoryService {
    ...
    async createCategory(data) {
        ...
        if (existing) {
            throw new app_error_1.AppError(error_codes_1.ErrorCode.CATEGORY_ALREADY_EXISTS, "Category already exists");
        }
    ...
    async updateCategory(id, data) {
        ...
        if (data.name) {
            ...
            if (existing) {
                throw new app_error_1.AppError(error_codes_1.ErrorCode.CATEGORY_ALREADY_EXISTS, "Category name already exists");
            }
        }
    ...
    async deleteCategory(id) {
        ...
        if (category._count.books > 0) {
            throw new app_error_1.AppError(error_codes_1.ErrorCode.CATEGORY_HAS_BOOKS, "Cannot delete category because it contains books");
        }
    ...
    async deleteCategories(ids) {
        ...
        if (categories.length === 0) {
            throw new app_error_1.AppError(error_codes_1.ErrorCode.CATEGORY_NOT_FOUND, "Categories not found");
        }
        ...
        if (categoriesWithBooks.length > 0) {
            ...
            throw new app_error_1.AppError(error_codes_1.ErrorCode.CATEGORY_HAS_BOOKS, `Cannot delete categories [${names}] because they contain books`);
        }
