...
const rule_runner_1 = require("@shared/engine/rule-runner");
const borrow_rules_1 = require("@shared/rules/borrow.rules");
class BorrowService {
    constructor() {
    ...
    async createBorrow(data) {
        ...
        return await db_1.default.$transaction(async (tx) => {
            ...
            const ruleResult = (0, rule_runner_1.runRules)(borrow_rules_1.borrowRuleSet, {
                user: {
                    id: user.id,
                    status: user.status,
