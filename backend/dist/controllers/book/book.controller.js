    ...
    constructor() {
        this.getAllBooks = async (req, res, next) => {
            try {
                ...
                const response = { data: books, code: error_enum_1.ErrorCode.SUCCESS };
                res.json(response);
            }
            catch (error) {
                next(error);
        ...
        this.getBookById = async (req, res, next) => {
            try {
                ...
                const response = { data: book, code: error_enum_1.ErrorCode.SUCCESS };
                res.json(response);
            }
            catch (error) {
                next(error);
        ...
        this.bulkDeleteBooks = async (req, res, next) => {
            try {
                ...
                const response = { data: result, code: error_enum_1.ErrorCode.SUCCESS };
                res.json(response);
            }
            catch (error) {
                next(error);
        ...
        this.fetchISBN = async (req, res, next) => {
            try {
                ...
                const response = { data: info, code: error_enum_1.ErrorCode.SUCCESS };
                res.json(response);
            }
            catch (error) {
                next(error);
