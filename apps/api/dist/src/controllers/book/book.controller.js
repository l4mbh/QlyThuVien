    ...
    constructor() {
        this.getAllBooks = async (req, res, next) => {
            try {
                ...
                const response = { data: books, code: shared_1.ErrorCode.SUCCESS };
                res.json(response);
            }
            catch (error) {
                next(error);
        ...
        this.fetchISBN = async (req, res, next) => {
            try {
                ...
                const response = { data: info, code: shared_1.ErrorCode.SUCCESS };
                res.json(response);
            }
            catch (error) {
                next(error);
        ...
        this.getInventoryLogs = async (req, res, next) => {
            try {
                ...
                const response = { data: logs, code: shared_1.ErrorCode.SUCCESS };
                res.json(response);
            }
            catch (error) {
                next(error);
